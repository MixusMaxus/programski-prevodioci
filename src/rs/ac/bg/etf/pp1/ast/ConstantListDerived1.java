...
public class ConstantListDerived1 extends ConstantList {

    private ConstantList ConstantList;
    private ConstantDeclaration ConstantDeclaration;

    public ConstantListDerived1 (ConstantList ConstantList, ConstantDeclaration ConstantDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstantListDerived1(\n");
