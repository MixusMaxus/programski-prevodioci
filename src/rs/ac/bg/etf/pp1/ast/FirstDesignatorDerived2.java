...
public class FirstDesignatorDerived2 extends FirstDesignator {

    private ActParsList ActParsList;

    public FirstDesignatorDerived2 (ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FirstDesignatorDerived2(\n");
