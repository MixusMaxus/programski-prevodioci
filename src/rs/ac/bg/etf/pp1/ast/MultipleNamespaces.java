...
public class MultipleNamespaces extends NamespaceList {

    private NamespaceList NamespaceList;
    private Namespace Namespace;

    public MultipleNamespaces (NamespaceList NamespaceList, Namespace Namespace) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleNamespaces(\n");
