...
public class NamespaceListDerived1 extends NamespaceList {

    private NamespaceList NamespaceList;
    private Namespace Namespace;

    public NamespaceListDerived1 (NamespaceList NamespaceList, Namespace Namespace) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NamespaceListDerived1(\n");
