...
public class MultipleDeclarations extends DeclarationList {

    private DeclarationList DeclarationList;
    private Declaration Declaration;

    public MultipleDeclarations (DeclarationList DeclarationList, Declaration Declaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleDeclarations(\n");
